...
2. **M3U8**:
   ...
   - إذا كان **TS-based** يتم دمج المقاطع تلقائيًا في ملف واحد للتنزيل المباشر باسم `.mp4` (قد يحتاج مشغّل مرن مثل VLC في بعض الحالات).
   - إذا كان البث محميًا فقد لا ينجح داخل المتصفح.
